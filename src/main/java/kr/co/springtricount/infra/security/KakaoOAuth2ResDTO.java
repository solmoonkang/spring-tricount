...
public record KakaoOAuth2ResDTO(
	Long id,
	...
	public record KakaoAccount(
		...
		public static KakaoAccount from(Map<String, Object> attributes) {
			...
			return new KakaoAccount(
				Boolean.valueOf(String.valueOf(attributes.get("profile_nickname_needs_agreements"))),
	...
	public static KakaoOAuth2ResDTO from(Map<String, Object> attributes) {

		return new KakaoOAuth2ResDTO(
